    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(related_name='onfido_events', on_delete=models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, help_text='The user who triggered the event.')),
            ],
        ),
    ]
