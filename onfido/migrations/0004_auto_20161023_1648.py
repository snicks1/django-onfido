...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='event',
            name='user',
            field=models.ForeignKey(related_name='onfido_events', on_delete=db.models.deletion.CASCADE, blank=True, to=settings.AUTH_USER_MODEL, help_text='The user who triggered the event.', null=True),
        ),
    ]
